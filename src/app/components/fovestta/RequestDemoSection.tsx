            ...
            {[
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[18px] font-semibold text-gray-900 group-hover:text-[#8B5CF6] transition-colors">{item.value}</p>
                </div>
              </motion.a>
            ))}
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3">
                    ...
                    <span className="text-[18px] font-medium text-purple-50">{text}</span>
                  </div>
                ))}
              </div>
            </motion.div>
