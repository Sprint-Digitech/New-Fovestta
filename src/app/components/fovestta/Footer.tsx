...
export function Footer() {
  return (
    <footer className="relative bg-[#FFF6F9] text-[#4C1D95] border-t border-[#FCE7F3]">
      <div className="w-full mx-auto px-6 lg:px-12 xl:px-24 py-12">
        {/* Main Footer Content */}
        <div className="grid md:grid-cols-2 lg:grid-cols-7 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-[20px] text-[#4C1D95] font-medium mb-6 max-w-[200px] leading-relaxed">
              Modern HR & Payroll for growing businesses.
            </p>
            
            <div className="space-y-6 text-[20px] font-medium text-[#4C1D95]">
              <div>
          ...
          {/* Product Column */}
          <div>
            <h4 className="text-[20px] font-bold text-gray-900 mb-6">Product</h4>
            <ul className="space-y-4 text-[20px] font-medium">
          ...
          {/* Company Column */}
          <div>
            <h4 className="text-[20px] font-bold text-gray-900 mb-6">Company</h4>
            <ul className="space-y-4 text-[20px] font-medium">
          ...
          {/* Resources Column */}
          <div>
            <h4 className="text-[20px] font-bold text-gray-900 mb-6">Resources</h4>
            <ul className="space-y-4 text-[20px] font-medium">
          ...
          {/* Tools Column */}
          <div>
            <h4 className="text-[20px] font-bold text-gray-900 mb-6">Tools</h4>
            <ul className="space-y-4 text-[20px] font-medium">
          ...
          {/* Legal Column */}
          <div>
            <h4 className="text-[20px] font-bold text-gray-900 mb-6">Legal</h4>
            <ul className="space-y-4 text-[20px] font-medium">
        ...
        <div className="pt-8 border-t border-[#FCE7F3] flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-[20px] font-medium text-[#4C1D95]">
            © 2026 Fovestta™. All rights reserved.
          </p>
          <div className="flex gap-6 text-[20px] font-medium text-[#4C1D95]">
