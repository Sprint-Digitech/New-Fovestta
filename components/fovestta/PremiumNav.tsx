          ...
          <div className="hidden lg:flex items-center gap-4 xl:gap-6 flex-shrink-0 justify-self-end">
            <div className="relative group">
              ...
              <div className="absolute top-full right-0 mt-2 w-[220px] bg-white rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] border border-gray-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 py-2">
                <Link href="/payroll-checklist" className="block px-5 py-3 text-[18px] font-medium text-gray-900 hover:bg-purple-50 hover:text-[#8B5CF6] transition-colors">
                  Payroll Checklist
                </Link>
                <Link href="/payroll-calculator" className="block px-5 py-3 text-[18px] font-medium text-gray-900 hover:bg-purple-50 hover:text-[#8B5CF6] transition-colors">
                  Cost Calculator
                </Link>
                <Link href="/compliance-scorecard" className="block px-5 py-3 text-[18px] font-medium text-gray-900 hover:bg-purple-50 hover:text-[#8B5CF6] transition-colors">
                  Compliance Scorecard
                </Link>
              </div>
            </div>

            <Link href="/request-demo" className="px-5 xl:px-6 py-2.5 bg-[#8B5CF6] text-white text-[13px] xl:text-[14px] font-bold rounded-xl hover:bg-[#7C3AED] transition-all duration-300 flex items-center gap-2 shadow-lg shadow-purple-100 whitespace-nowrap">
              Get Started
          ...
          {isOpen && (
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                <Link href="/request-demo" onClick={() => setIsOpen(false)} className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-[#8B5CF6] text-white text-[15px] font-bold rounded-xl text-center shadow-lg shadow-purple-100">
                  Get Started
                  <ArrowUpRight className="w-4 h-4" />
                </Link>
              </div>
