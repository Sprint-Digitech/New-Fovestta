      ...
      <div className="relative z-10 max-w-[90rem] mx-auto px-4 lg:px-4">
          ...
          <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li><FooterLink href="/support">Contact</FooterLink></li>
              </ul>
            </div>
        ...
        <div className="py-5 border-t border-[#FCE7F3] flex flex-wrap justify-center lg:justify-between items-center gap-6">
          <div className="flex items-center gap-3">
             ...
             <a
               href="https://maps.google.com/maps?q=111,%20F-Block,%20Sector%208,%20Noida,%20Uttar%20Pradesh%20201301"
               target="_blank"
               rel="noopener noreferrer"
               className="text-[14px] font-bold text-[#4C1D95] hover:text-[#8B5CF6] transition-colors"
             >
               111, F-Block, Sector 8, Noida, U.P.-201301
             </a>
          </div>
          <div className="flex items-center gap-3">
        ...
        <div className="pt-3 border-t border-[#FCE7F3] flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
            ...
            <div className="flex gap-6">
              <Link href="/terms" className="text-[13px] font-bold text-[#4C1D95]/40 hover:text-[#8B5CF6] transition-colors uppercase tracking-widest">Terms</Link>
              <Link href="/privacy" className="text-[13px] font-bold text-[#4C1D95]/40 hover:text-[#8B5CF6] transition-colors uppercase tracking-widest">Privacy</Link>
            </div>
          </div>
