        ...
        <div className="grid lg:grid-cols-[1.1fr_1fr] gap-10 items-center flex-grow">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#F5F3FF] shadow-sm mb-4">
              <span className="text-[#6B46FF] text-[16px] font-bold flex items-center gap-1.5">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-6">
              <Link href="/request-demo" className="flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-[#6B46FF] to-[#4F46E5] text-white text-[16px] font-bold rounded-full shadow-lg hover:shadow-xl transition-all duration-300 text-center">
                Book Free Demo
                <ArrowUpRight className="w-5 h-5" />
              </Link>

              <Link href="/request-demo" className="flex items-center gap-3 px-8 py-4 bg-white border border-gray-200 text-gray-900 text-[16px] font-bold rounded-full shadow-md hover:bg-gray-50 transition-all duration-300 text-center">
